...
Review GitHub pull requests for the `filipamesquita/nurseApp` repository.
...
#### Onion architecture / DDD conventions
<Domain purity violations (framework imports in domain/), aggregate boundary
violations, missing value-object validation, TDD convention deviations
(mock naming, SUT placement, AAA structure) — see architecture.md and the
java-ddd skill>
